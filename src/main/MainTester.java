...
public class MainTester {
    public static void main(String[] args) throws SQLException {
        ...
        db.executeStructureQuery("DROP DATABASE sample/123123/hobba");
//        db.createDatabase("sc1", true);
...
////        db.createDatabase("sample/123123/hobba", false);

//        DatabaseManager.getInstance().dropDatabase("sample/123123/hobba");
...
//        db.createDatabase("sc1", true);
//        System.out.println(db.executeStructureQuery("CREate Table t2 (id int,name varchar)"));
//        System.out.println(db.executeUpdateQuery("insert into t2 values (1,'Ayman')"));
//        System.out.println(db.executeUpdateQuery("insert into t2 (name) values ('Kaled')"));
//        System.out.println(db.executeUpdateQuery("insert into t2 (id) values (-1)"));
//        System.out.println();
//        select(db,"SElect * From t2");
//        System.out.println();
//        select(db,"SElect name From t2");
//        System.out.println();
//        select(db,"SElect id From t2");
//        System.out.println();
//        select(db,"SElect * From t2 where id = 0");
//        System.out.println();
//        select(db,"SElect * From t2 where id > 0");
//        System.out.println();
//        select(db,"SElect * From t2 where id <= 0");    // Error Here
//        System.out.println();
//        System.out.println(db.executeUpdateQuery("DElete * From t2"));
//        System.out.println();
//        select(db,"SElect * From t2");
    }
